...
%2\SampleService.exe -install SampleService %1\jvm.dll -Djava.class.path=%2\; -Xms16M -Xmx64M -start org.objectweb.javaservice.test.SampleService -params start -stop org.objectweb.javaservice.test.SampleService -method serviceStop -out %2\stdout.log -err %2\stderr.log -current %2 %4
