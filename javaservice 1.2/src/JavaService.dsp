...
# ADD CPP /nologo /W3 /GX /O2 /I "..\..\j2sdk\include" /I "..\..\j2sdk\include\win32" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /c
...
# ADD LINK32 advapi32.lib /nologo /subsystem:console /machine:I386 /out:"../bin/JavaService.exe"
...
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "..\..\j2sdk\include" /I "..\..\j2sdk\include\win32" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /GZ /c
...
# ADD LINK32 advapi32.lib /nologo /subsystem:console /incremental:no /debug /machine:I386 /out:"../bin/JavaServiceDebug.exe" /pdbtype:sept
