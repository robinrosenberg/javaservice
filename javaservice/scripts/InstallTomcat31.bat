...
%2\bin\Tomcat.exe -install Tomcat %1\jre\bin\server\jvm.dll -Djava.class.path=%2\lib\webserver.jar;%2\lib\jasper.jar;%2\lib\xml.jar;%2\lib\servlet.jar;%1\lib\tools.jar -Dtomcat.home=%2 -start org.apache.tomcat.startup.Tomcat -params start -stop org.apache.tomcat.startup.Tomcat -params -stop -out %2\logs\stdout.log -err %2\logs\stderr.log
