...
%2\bin\TomcatService.exe -install Tomcat %1\jre\bin\server\jvm.dll -Djava.class.path=%2\bin\bootstrap.jar;%2\bin\servlet.jar;%1\lib\tools.jar -Dcatalina.home=%2 -start org.apache.catalina.startup.Bootstrap -params start -stop org.apache.catalina.startup.Bootstrap -params stop -out %2\logs\stdout.log -err %2\logs\stderr.log
