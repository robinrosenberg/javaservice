...
#ifndef __ABSTRACT_COMMAND_H__
#define __ABSTRACT_COMMAND_H__
...
private:
	AbstractCommand(const AbstractCommand& other);
	AbstractCommand& operator=(const AbstractCommand& other);
};

#endif // __ABSTRACT_COMMAND_H__
