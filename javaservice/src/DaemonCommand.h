...
#ifndef __DAEMON_COMMAND_H__
#define __DAEMON_COMMAND_H__

#include "CommandInterface.h"

class DaemonCommand : public CommandInterface
{
public:
	...
	// execute the command - run the background service process
	int execute();


	const char* getCommandName() const { return "DaemonCommand"; }

private:

	// copy constructor and operators private and not implemented
	DaemonCommand(const DaemonCommand& other);
	DaemonCommand& operator=(const DaemonCommand& other);
};

#endif // __DAEMON_COMMAND_H__
