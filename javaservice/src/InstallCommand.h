...
#ifndef __INSTALL_COMMAND_H__
#define __INSTALL_COMMAND_H__

#include "ServiceCommand.h"

class ServiceParameters;

class InstallCommand : public ServiceCommand
{
public:

	InstallCommand(const char* _serviceName, int servArgc, char* servArgv[]);

	~InstallCommand();

	int execute();

	const char* getCommandName() const { return "InstallCommand"; }
...
private:
	...
	bool validateParameters(int servArgc, char* servArgv[]);


	InstallCommand(const InstallCommand& other);
	InstallCommand& operator=(const InstallCommand& other);
};

#endif // #ifndef __INSTALL_COMMAND_H__
